...
import com.stockapp.gateway.web.rest.errors.ExceptionTranslator;
...
public class WebConfigurer implements WebFluxConfigurer {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        LOG.info("CORS Configuration loaded: {}", config);
        ...
        if (!CollectionUtils.isEmpty(config.getAllowedOrigins()) || !CollectionUtils.isEmpty(config.getAllowedOriginPatterns())) {
            LOG.info("Registering CORS filter for paths");
            ...
            LOG.warn("CORS configuration is empty - no origins or patterns configured");
        }
        return source;
    }
