...
/**
 * Service Implementation for managing {@link com.stockapp.stockservice.domain.IntradayQuote}.
 */
@Service
public class IntradayQuoteService {
    ...
    public IntradayQuoteService(IntradayQuoteRepository intradayQuoteRepository, IntradayQuoteMapper intradayQuoteMapper) {
    ...
    public Mono<IntradayQuoteDTO> save(IntradayQuoteDTO intradayQuoteDTO) {
        ...
        return intradayQuoteRepository.save(intradayQuoteMapper.toEntity(intradayQuoteDTO)).map(intradayQuoteMapper::toDto);
    }
