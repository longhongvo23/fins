...
class HistoricalPriceResourceIT {
    ...
    private static final Instant UPDATED_DATETIME = Instant.parse("2024-01-01T00:00:00Z");
    ...
    void getAllHistoricalPrices() {
        ...
        webTestClient
                ...
                .jsonPath("$.[*].datetime")
                .value(hasItem(DEFAULT_DATETIME.toString()))
                .jsonPath("$.[*].interval")
    ...
    void getHistoricalPrice() {
        ...
        webTestClient
                ...
                .jsonPath("$.datetime")
                .value(is(DEFAULT_DATETIME.toString()))
                .jsonPath("$.interval")
