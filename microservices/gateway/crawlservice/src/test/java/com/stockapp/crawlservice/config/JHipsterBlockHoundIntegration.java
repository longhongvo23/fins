...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.stockapp.crawlservice.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.stockapp.crawlservice.security.DomainUserDetailsService", "createSpringSecurityUser");
