...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.stockapp.userservice.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.stockapp.userservice.security.DomainUserDetailsService", "createSpringSecurityUser");
