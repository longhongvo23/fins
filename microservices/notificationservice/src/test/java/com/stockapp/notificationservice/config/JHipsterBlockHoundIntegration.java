package com.stockapp.notificationservice.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.stockapp.notificationservice.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.stockapp.notificationservice.security.DomainUserDetailsService", "createSpringSecurityUser");
