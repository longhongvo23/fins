 ...
 * {@link com.stockapp.stockservice.domain.Financial}.
 */
@Service
public class FinancialService {
    ...
    /**
     * Find financials by symbol
     *
     * @param symbol   the stock symbol
     * @param pageable the pagination information
     * @return the list of entities
     */
    public Flux<FinancialDTO> findBySymbol(String symbol, Pageable pageable) {
        LOG.debug("Request to get Financials by symbol : {}", symbol);
        return financialRepository.findBySymbol(symbol, pageable).map(financialMapper::toDto);
    }
}
