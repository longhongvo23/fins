 ...
 * {@link com.stockapp.stockservice.domain.Company}.
 */
@Service
public class CompanyService {
     ...
     */
    public Mono<CompanyDTO> findBySymbol(String symbol) {
        LOG.debug("Request to get Company by symbol: {}", symbol);
        return companyRepository.findBySymbol(symbol).map(companyMapper::toDto);
    }
