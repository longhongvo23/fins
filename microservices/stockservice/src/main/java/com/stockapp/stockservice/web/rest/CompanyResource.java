...
/**
 * REST controller for managing {@link com.stockapp.stockservice.domain.Company}.
 */
@RestController
...
public class CompanyResource {
    ...
    private static final String ENTITY_NAME = "stockserviceCompany";
     ...
     */
    @GetMapping("/{id}")
    public Mono<ResponseEntity<CompanyDTO>> getCompany(@PathVariable("id") String id) {
