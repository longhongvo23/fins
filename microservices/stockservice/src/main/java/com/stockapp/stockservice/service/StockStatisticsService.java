 ...
 * {@link com.stockapp.stockservice.domain.StockStatistics}.
 */
@Service
public class StockStatisticsService {
    ...
    public StockStatisticsService(StockStatisticsRepository stockStatisticsRepository,
    ...
    public Mono<StockStatisticsDTO> save(StockStatisticsDTO stockStatisticsDTO) {
        ...
        return stockStatisticsRepository.save(stockStatisticsMapper.toEntity(stockStatisticsDTO))
    ...
    /**
     * Find stockStatistics by symbol
     *
     * @param symbol the stock symbol
     * @return the entity
     */
    public Mono<StockStatisticsDTO> findBySymbol(String symbol) {
        LOG.debug("Request to get StockStatistics by symbol : {}", symbol);
        return stockStatisticsRepository.findBySymbol(symbol).map(stockStatisticsMapper::toDto);
    }
}
