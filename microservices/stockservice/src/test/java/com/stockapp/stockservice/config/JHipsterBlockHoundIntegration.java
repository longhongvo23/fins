...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.stockapp.stockservice.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.stockapp.stockservice.security.DomainUserDetailsService", "createSpringSecurityUser");
