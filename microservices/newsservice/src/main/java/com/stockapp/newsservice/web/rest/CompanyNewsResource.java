 ...
 * {@link com.stockapp.newsservice.domain.CompanyNews}.
 */
@RestController
...
public class CompanyNewsResource {
     ...
     *         body the new companyNewsDTO, or with status {@code 400 (Bad Request)}
     *         if the companyNews has already an ID.
     ...
     *         the updated companyNewsDTO,
     *         or with status {@code 400 (Bad Request)} if the companyNewsDTO is not
     *         valid,
     *         or with status {@code 500 (Internal Server Error)} if the
     *         companyNewsDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/{id}")
    public Mono<ResponseEntity<CompanyNewsDTO>> updateCompanyNews(
            @PathVariable(value = "id", required = false) final String id,
            @Valid @RequestBody CompanyNewsDTO companyNewsDTO) throws URISyntaxException {
    ...
    /**
     * {@code PATCH  /company-news/:id} : Partial updates given fields of an
     * existing companyNews, field will ignore if it is null
     *
     * @param id             the id of the companyNewsDTO to save.
     * @param companyNewsDTO the companyNewsDTO to update.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body
     ...
     *         or with status {@code 400 (Bad Request)} if the companyNewsDTO is not
     *         valid,
     *         or with status {@code 404 (Not Found)} if the companyNewsDTO is not
     *         found,
     *         or with status {@code 500 (Internal Server Error)} if the
     *         companyNewsDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
    ...
    public Mono<ResponseEntity<CompanyNewsDTO>> partialUpdateCompanyNews(
            @PathVariable(value = "id", required = false) final String id,
            @NotNull @RequestBody CompanyNewsDTO companyNewsDTO) throws URISyntaxException {
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body
     *         the companyNewsDTO, or with status {@code 404 (Not Found)}.
     */
    @GetMapping("/{id}")
    ...
    /**
     * {@code GET  /company-news/by-symbol/:symbol} : get news by stock symbol.
     *
    ...
    public Mono<ResponseEntity<List<CompanyNewsDTO>>> getNewsBySymbol(
            @PathVariable String symbol,
            @RequestParam(defaultValue = "20") int limit) {
        LOG.debug("REST request to get news for symbol: {}", symbol);
    ...
    /**
     * {@code GET  /company-news/latest} : get latest news articles.
     *
     * @param limit maximum number of articles to return
     * @return the list of latest news articles
     */
    @GetMapping("/latest")
    public Mono<ResponseEntity<List<CompanyNewsDTO>>> getLatestNews(
            @RequestParam(defaultValue = "50") int limit) {
        LOG.debug("REST request to get latest {} news articles", limit);
